// ==========================================================================
// LIVE CLOCK (mono readout in nav — reinforces HUD/telemetry feel)
// ==========================================================================
function tickClock(){
...
// ==========================================================================
// COPY TO CLIPBOARD (email / telegram)
// ==========================================================================
document.querySelectorAll('.copyable').forEach(btn => {
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      // clipboard API unavailable — fall back silently, still show feedback
    }

    const original = flag.textContent;
    flag.textContent = 'СКОПИРОВАНО';
